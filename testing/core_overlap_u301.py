...
if 1:
    outname = "u301_tracks_core_258.h5"
...
#kludge={'peak_id':[ 368, 369]}
    ...
    leaf_storage_here={}
    MT=mountain_top.cut_mountain_top( this_simname, target_fname = mountain_top_name, do_projections=True, verify=coreset_data.verify_cores_u301,
                                     kludge=kludge, leaf_storage=leaf_storage_here, radius_dict=coreset_data.radius_301)
