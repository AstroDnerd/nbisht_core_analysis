...
class brho():
    ...
    def run(self,do_all_plots=True,core_list=None):
        ...
        for core_id in core_list:
            ...
            if ms.nparticles < 3:   # why less than 3?
                continue
            print('go ', core_id)
            ...
            #  NEED THE FIELD HERE: do the math with these
...
if 'BrhoOm_tool1' not in dir():
    BrhoOm_tool1=trial(tl.looper1)
    BrhoOm_tool1.run(do_all_plots=False)
    #BrhoOm_tool2=trial(tl.looper2)
    #BrhoOm_tool2.run(do_all_plots=False)
    #BrhoOm_tool3=trial(tl.looper3)
    #BrhoOm_tool3.run(do_all_plots=False)
   

#ds = tl.looper1.load(frame=125)
#ad = ds.all_data()
