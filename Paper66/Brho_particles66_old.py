...
def plot_particles(axes,nframe):  
    for core_id in all_cores:
        ...
        for n_count,n_time in enumerate(asort): 
            ...
            if n_time == nframe: 
                axes.scatter(density[:,n_time],magfield[:,n_time],c='k',label=thtr.times[n_time],s=0.1)           
    return
