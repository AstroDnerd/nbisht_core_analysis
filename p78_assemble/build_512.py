...
if 'ds512' not in dir():
    ds512  = yt.load('/anvil/scratch/x-ux454321/p78c_high_res/512/B2/RS0000/restart0000')
    ...
    output_directory='/anvil/scratch/x-ux454321/p78c_high_res/IC_assembler/Run512'

if 1:
    #build the set
    bs.write_enzo_set(stuff[0],output_directory,field='p19b_b2_density.512')
    bs.write_enzo_set(stuff[1],output_directory,field='p19b_b2_vx.512')
    bs.write_enzo_set(stuff[2],output_directory,field='p19b_b2_vy.512')
    bs.write_enzo_set(stuff[3],output_directory,field='p19b_b2_vz.512')
    bs.write_enzo_set(stuff[4],output_directory,field='p19b_b2_bx.512',extend=0 )
    bs.write_enzo_set(stuff[5],output_directory,field='p19b_b2_by.512',extend=1 )
    bs.write_enzo_set(stuff[6],output_directory,field='p19b_b2_bz.512',extend=2 )
