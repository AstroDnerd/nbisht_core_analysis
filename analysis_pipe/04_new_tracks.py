...
this_simname = 't02'
mountain_top_fname = "datasets_small/%s_mountain_tops.h5"%this_simname
outname = "%s/%s_tracks_every_10.h5"%(dl.coresets['ourset'], this_simname)
target_frame = dl.target_frames[this_simname]

if 0:
    #One simulation has a bunch of bad particles that need to get cut out.
...
if 1:
    new_looper = looper_main(directory= dl.sims[this_simname],
