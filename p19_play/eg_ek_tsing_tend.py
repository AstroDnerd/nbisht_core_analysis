    ...
    def run(self,this_looper,core_list=None, do_plots=True, r_inflection=None, frame_list=None, tsing=None):
        ...
        for core_id in core_list:
            ...
            for nframe,frame in enumerate(frame_list):
                ...
                ax5[1][nframe].plot( RR_cuml, EK_cuml, c=c, linewidth=linewidth)
                ax5[2][nframe].plot( RR_cuml, EG_cuml/EK_cuml, c=c, linewidth=linewidth)
        ...
        ax5[1][0].set(ylabel='Ek', ylim=y_ext.minmax)
        ax5[2][0].set(ylabel='EG/EK', ylim=[1e-3,1e3])
        ...
        fig5.savefig('plots_to_sort/eg_ek_swarm_tsing_%s'%(this_looper.sim_name))
