...
class BRho_tool():
                ...
                if 1:
                    if core_id == core_list[-1]:
                        if name == 'u601':
                            ...
                            meanbear = [0.183968978034035, 0.1767537518780229, 0.23378802757907274, 0.22471674175614634, 0.19262744983375352, 0.2088691413493051, 0.4546466215799298, \
                                        0.47856225325652085, 0.5355668747582093, 0.4390659221753002, 0.5899754540720902, 0.4835561095148559, 0.4926736033599136, 0.4703515554882766]
                        if name == 'u602':
                            ...
                            meanbear = [0.23795124422441552, 0.2740075425004681, 0.3282800121484023, 0.3739361638057802, 0.4688902783457024, 0.49447632258414487, 0.5524764599014013,\
                                        0.493771212749963, 0.4808226955425633, 0.41083291063808564, 0.2751574945681307, 0.2814547695474375, 0.4977483584918941] 
                        if name == 'u603': 
                            #meanbear = [0.279555,0.336840,0.355424,0.325673,0.268460,0.232444,0.258084,0.252883,0.206200,0.239367,0.283474,0.617871]
                            meanbear = [0.24862548506412568, 0.24578058189528446, 0.3799296069429897, 0.4678298139732984, 0.5007514866768801, 0.6200380759209618, 0.6257098488176192, \
                                        0.5617834293342657, 0.4529755638479911, 0.2703277229723311, 0.25567884836052857, 0.626969107162056]
    ...
    def boxes(self,num,name,tff_lab): 
        ...
        ylim = -0.5,1.0
        BRho_tool.labelled(ax1,xlabel=r'$t/t_{\rm{ff}}$',ylabel=r'$\kappa$',ylim=ylim) 
        fig.savefig('BearsBoxplot_cf%s_new'%name)
        print("BOX SAVED")
        plt.close(fig)
